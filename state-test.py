...
class Person(object):
    ...
    def match_qr(self, qr_text, location):
    ...
    def log(self, location):
        ...
        if self._state == True:
            if len(self._logs[-1]) == 2 and self._logs[-1][1][0] == "IN":
                    ...
                    if not self._logs[-1][0] == location:
                        self._logs.append([location, ["IN", calendar.timegm(time.gmtime())]])
                    else:
...
print arthur.match_qr("example", "Mechatronics Lab")
print arthur._logs

print arthur.match_qr("shots fired", "Mechatronics Lab")
print arthur._logs

print "Workshop: "
print arthur.match_qr("shots fired", "Workshop")
print arthur._logs
